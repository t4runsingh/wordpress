...
The quickest and easiest way to get a fully customizable contact form on your WordPress blog. Join over 100,000 users who have chosen ContactMe as their contact form of choice!

= The most robust FREE Contact Form plugin on Wordpress =

Our Contact Form plugin is packed with features that no other wordpress contact form offers. See below for just a few of the features we offer:

*  Add custom contact form fields including text, dropdown menus, radio buttons, checkboxes, date&time pickers and more!
*  Access all of your contact form settings and customizations from right within your Wordpress Admin Panel
*  Include your logo, map, business contact info,  even social links right on your contact form
*  Add a CAPTCHA to your contact form to kill spam
*  Setup an autoresponder for your contact form so your visitors get an instant message from you
*  Setup a custom success message or URL for your contact form
*  Get contact form notifications to your inbox and via SMS!
*  Add custom code or scripts to your contact form for tracking ROI campaigns
*  Add a custom tab “Contact” tab to the side of your website or blog that pops up your contact form and increases conversion!
*  ...and many more features for your contact form!
 
= More than a Contact Form =

Behind the contact form is a complete suite of online tools to effectively manage all of your leads, contacts, tasks, appointments, and more. As leads come in from your contact form, those contacts are automatically added to your online contacts database in your free ContactMe.com account.   From there, you can not only access your form submissions and contacts, but you can fully track, organize, and manage your communications by taking notes on the contact, creating a to-do list grouping and categorizing your contacts, and much more.
 
= Our Contact Form even supports the following 16 languages and counting! =
...
ContactMe.com’s contact form is FREE and is the new standard in wordpress contact forms.  We think you will agree that its way better than anything else out there including contact form 7!
...
= Coming Soon =
* Contact Form: Custom CSS for styling
* Contact Form: More new languages for button and contact form

= 2.3 =
* Added link to external signup form.

= 2.2 =
* Removed in-app signup form

= 2.1 =
* Contact Form: Custom success messages 
* Contact Form: Custom javascript for analytics
...
* Fixed: Facebook contact form
* Fixed: Embed contact form
...
* Arabic: Available contact form and button
* Bulgarian: Available contact form and button
* Dutch: Available contact form and button
* Español: Available contact form and button
* Français: Available contact form and button
* Greek: Available contact form and button
* Norwegian: Available contact form and button
* Polish: Available contact form and button
* Português: Available contact form and button
* Russian: Available contact form and button
* Swedish: Available contact form and button
* Turkish: Available contact form and button